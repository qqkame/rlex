      ...
      try {
        ...
        if(member.user.bot) {
            if(data) {
                ...
                .setTitle("<:tik1:1211728664123674734> | Bot Onaylandı!")
            ...
            channel.send({
                content: `<@${member.user.id}>`, embeds: [
                    new Discord.EmbedBuilder()
                        ...
                        .setDescription('• Merhaba Metrus kullanıcısı, seni sunucumuza güvenle alabilmek için altta bulunan yazıyı butona tıklayarak yazman gerekiyor.')
