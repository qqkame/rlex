...
module.exports = {
    ...
    run: async (client, interaction) => {
        ...
        if (!interaction.member.roles.cache.has(db.fetch(`yetkili_${interaction.guild.id}`))) return interaction.reply(`<:x_:1211729272364990465> | Bu komutu sadece ayarlanan **Mute Yetkilisi** rolü olan kişiler kullanabilir.`)
