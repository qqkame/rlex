    ...
    switch(kufurEngelSystemTrue) {
      case "ac": {
        ...
        if (kufurEngelSystem && kufurengelDate) {
            ...
            .setDescription(`<:x_:1211729272364990465> | Bu sistem <t:${parseInt(kufurengelDate.date / 1000)}:R> önce açılmış!`)
      ...
      case "kapat": {
        if(!kufurEngelSystem) return interaction.reply({ content: "<:x_:1211729272364990465> | Bu sistem zaten kapalı?" });
