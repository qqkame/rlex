...
module.exports = {
    ...
    run: async (client, interaction) => {
        ...
        if (ticketSystem && ticketSystemDate) {
            ...
            .setDescription(`<:x_:1211729272364990465> | Bu sistem <t:${parseInt(ticketSystemDate.date / 1000)}:R> önce açılmış!`)
        ...
        const basarili = new EmbedBuilder()
            .setColor("Green")
            .setDescription(`<:tik1:1211728664123674734> | __**Destek Sistemi**__ başarıyla ayarlandı!\n\n<:kanal:1040649841996464139> Destek Kanalı: ${ticketkanal}\n<:kanal:1040649841996464139> Log Kanalı: ${logkanal}\n<:bot:1211766999995121764> Yetkili Rolü: ${rol}`)
