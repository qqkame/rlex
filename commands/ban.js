...
module.exports = {
  ...
  run: async(client, interaction) => {
    ...
    if(user.permissions.has(PermissionsBitField.Flags.BanMembers)) return interaction.reply({content:"<:x_:1211729272364990465> | Bu Kullanıcının Ban Yetkisi Olduğu İçin Onu Yasaklayamadım.   ",ephemeral:true})
    user.ban({reason: sebep});
    interaction.reply({content: "<:tik1:1211728664123674734> | Başarıyla Üyeyi Yasakladım!"})
}
