...
module.exports = {
    ...
    run: async (client, interaction) => {
        ...
        const logMessage = new EmbedBuilder()
            .setColor("Yellow")
            .setTitle("<:tik1:1211728664123674734> | Bir Üye Susturuldu!")
        ...
        const basarili = new EmbedBuilder()
            .setColor("Green")
            .setDescription(`<:tik1:1211728664123674734> | ${kullanıcı} adlı kullanıcıya **${süre}** süre boyunca timeout atıldı!`)
