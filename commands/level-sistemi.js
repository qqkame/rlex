    ...
    switch(levelSystemTrue) {
      case "ac": {
        ...
        if (levelSystem && levelSystemDate) {
            ...
            .setDescription(`<:x_:1211729272364990465> | Bu sistem <t:${parseInt(levelSystemDate.date / 1000)}:R> önce açılmış!`)
      ...
      case "kapat": {
        if(!levelSystem) return interaction.reply({ content: "<:x_:1211729272364990465> | Bu sistem zaten kapalı?" });
