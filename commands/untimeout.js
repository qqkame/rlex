...
module.exports = {
    ...
    run: async (client, interaction) => {
        ...
        const logMessage = new EmbedBuilder()
            .setColor("Green")
            .setTitle("<:tik1:1211728664123674734> | Bir Üye'nin Susturması Kaldırıldı!")
        ...
        const basarili = new EmbedBuilder()
            .setColor("Green")
            .setDescription(`<:tik1:1211728664123674734> | ${kullanıcı} adlı üyenin susturmasını kaldırdım.`)
