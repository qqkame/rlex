    ...
    switch(reklamEngelSystemTrue) {
      case "ac": {
        ...
        if (reklamEngelSystem && reklamEngelSystemDate) {
            ...
            .setDescription(`<:x_:1211729272364990465> | Bu sistem <t:${parseInt(reklamEngelSystemDate.date / 1000)}:R> önce açılmış!`)
      ...
      case "kapat": {
        if(!reklamEngelSystem) return interaction.reply({ content: "<:x_:1211729272364990465> | Bu sistem zaten kapalı?" });
