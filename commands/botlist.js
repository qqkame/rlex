...
module.exports = {
    ...
    run: async (client, interaction) => {
        ...
        const basarili = new Discord.EmbedBuilder()
            .setColor("Green")
            .setTitle("<:tik1:1211728664123674734> | Başarıyla Ayarlandı!")
            .setDescription("<:tik1:1211728664123674734> | Botlist sistemi başarıyla ayarlandı!")
            .setFooter({ text: "Metrus" })


            const menu = new Discord.EmbedBuilder()
            .setColor("000000")
            .setTitle(":grey_question: | Botumu Nasıl Eklerim?")
