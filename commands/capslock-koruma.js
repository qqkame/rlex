   ...
   switch(capslockSystemTrue) {
    case "ac": {
      ...
      if (capslockSystem && capslockSystemDate) {
          ...
          .setDescription(`<:x_:1211729272364990465> | Bu sistem <t:${parseInt(capslockSystemDate.date / 1000)}:R> önce açılmış!`)
    ...
    case "kapat": {
      if(!capslockSystem) return interaction.reply({ content: "<:x_:1211729272364990465> | Bu sistem zaten kapalı?" });
