...
module.exports = {
    ...
    run: async (client, interaction) => {
        ...
        if (kayitSistemi && kayıtSistemiDate) {
            ...
            .setDescription(`<:x_:1211729272364990465> | Bu sistem <t:${parseInt(kayıtSistemiDate.date / 1000)}:R> önce açılmış!`)
        ...
        const basarili = new EmbedBuilder()
            .setColor("Green")
            .setDescription(`<:tik1:1211728664123674734> | __**Kayıt Sistemi**__ başarıyla ayarlandı!\n\n<:kanal:1040649841996464139> Kayıt Kanalı: ${kayıtkanal}\n<:bot:1211766999995121764> Kayıtlı Rolü: ${kayıtlırol}\n<:bot:1211766999995121764> Kayıtsız Rolü: ${kayıtsızrol}`)
